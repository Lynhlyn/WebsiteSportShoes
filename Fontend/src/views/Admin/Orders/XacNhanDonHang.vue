  ...
  <div class="container">
    ...
    <div class="status-bar">
      <template v-for="(step, index) in steps" :key="index">
        <div
          class="status-step"
          :class="{ active: index <= currentStep, inactive: index > currentStep }"
        >
          {{ step }}
        </div>
        <div
    ...
    <div class="info-grid">
      <!-- Trái -->
      <div class="info-box">
        <h2 class="title">Thông tin hóa đơn <span class="bold"></span></h2>
        <p><strong>Trạng thái:</strong> <span class="label paid"></span></p>
        <p><strong>Loại hóa đơn:</strong> <span class="label counter">Online</span></p>
      ...
      <div class="info-box">
        ...
        <p><strong>SDT người nhận:</strong></p>
